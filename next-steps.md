...
#### Database connections for `spring-petclinic`

- `MYSQL_*` environment variables are configured in [spring-petclinic.bicep](./infra/app/spring-petclinic.bicep) to connect to the Mysql database. Modify these variables to match your application's needs.
...
- [app/spring-petclinic.bicep](./infra/app/spring-petclinic.bicep) - Azure Container Apps resources to host the 'spring-petclinic' service.
- [app/db-mysql.bicep](./infra/app/db-mysql.bicep) - Azure MySQL Flexible Server to host the 'rujchemsql' database.
